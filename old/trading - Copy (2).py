    ...
    for a,stock in enumerate(stocks):
        ...
        for b,time_of_year in enumerate(times_of_year):
            ...
            for c,random in enumerate(randoms):
                ...
                #acceptance_timestamps.append(acceptance_timestamp)
                #continue
                begin_iden = ">"
                ...
                #acceptance_timestamps[acceptance_timestamp] = {extracted:}
                ...
                acceptance_timestamps[acceptance_timestamp] = {extracted:{converted:BMO_or_AMC}}
                continue
                
        master[stock] = acceptance_timestamps
        for stock,value1 in master.items():
            for key2,value2 in value1.items():
                print(stock,key2,value2)
        continue
